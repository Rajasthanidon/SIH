...
function InstitutionSignup() {
    ...
    const handleSubmit = (e) => {
        ...
        // fetch("http://localhost:5000/api/institution/signup", {...})
            ...
            <main className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2">
                ...
                <section className="hidden lg:flex flex-col justify-between p-10 xl:p-14 bg-white/[0.04] border-r border-white/10">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/10 text-2xl border border-white/10" onClick={() => navigate("/")}>
                            📖
                        </div>
                    ...
                    <div className="my-10">
                        ...
                        <p className="mt-6 max-w-lg text-gray-400 leading-relaxed">
                            Join a vibrant ecosystem of educators,
                        ...
                        <div className="mt-10 flex justify-center">
                            <img
                                ...
                                alt="Institution building illustration"
                    ...
                    <div className="space-y-3">
                        ...
                        <FeatureCard
                            ...
                            description="Build partnerships and real-world connections"
                        />

                        <FeatureCard
                            icon="💡"
                            title="Empower innovation"
                            description="Encourage ideas and turn them into impact"
                        />
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <VerifyInput
                                        ...
                                        name="officialEmail"
                                        type="email"
                                        placeholder="Enter your official institution email"
                                    ...
                                    <VerifyInput
                                        ...
                                        name="contactNumber"
                                        type="tel"
                                        placeholder="Enter institution's contact number"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <SelectField
                                        ...
                                        options={[
                                            ...
                                            ["tpo", "Training and Placement Officer (TPO)"],
                            ...
                            >
                                ...
                                {formData.confirmPassword && (
                                    <p
                                        className={`mt-2 text-sm ${formData.password === formData.confirmPassword
                                            ? "text-green-400"
                                            : "text-red-400"
                                            }`}
                                    >
                            ...
                            <button
                                type="submit"
                                className="w-full rounded-xl bg-blue-600 hover:bg-blue-500 active:scale-[0.98] py-3.5 font-semibold transition-all duration-300 shadow-lg shadow-blue-900/30"
                            >
                                Create Account
                            </button>
...
function FormSection({ icon, title, children }) {
    return (
        <fieldset className="rounded-2xl border border-white/10 bg-black/10 p-4 sm:p-5">
    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
                ...
                <button
                    type="button"
                    className="rounded-xl bg-blue-500/20
